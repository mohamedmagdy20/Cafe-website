    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{route('dashboard.banners.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            <label>Body</label>
                            <textarea name="body" class="body"  id="body" cols="30" rows="10">{!! old('body') !!}</textarea>
                            @error('body')
                            <span class="text-danger"> {{ $message }} </span>
                            @enderror                           
                          </div>
